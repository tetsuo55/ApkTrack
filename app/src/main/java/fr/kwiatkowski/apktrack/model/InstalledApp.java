...
{
    public InstalledApp() {} // Default constructor for SugarORM
     ...
     */
    public String  get_update_source()               { return _update_source; }

    // --------------------------------------------------------------------------------------------

    public void     set_ignored(boolean ignored)                { _is_ignored = ignored; }
    public void     set_version(String version)                 { _version = version; }
    public void     set_has_notified(boolean has_notified)      { _has_notified = has_notified; }
    public void     set_latest_version(String latest_version)   { _latest_version = latest_version; }
    public void     set_update_source(String update_source)     { _update_source = update_source; }
